...
# Type: String
c.content.headers.accept_language = 'en-CA,en-US,en'
...
# Type: Font
c.fonts.monospace = '"Iosevka", "Iosevka Term", "xos4 Terminus", Terminus, Monospace, "DejaVu Sans Mono", Monaco, "Bitstream Vera Sans Mono", "Andale Mono", "Courier New", Courier, "Liberation Mono", monospace, Fixed, Consolas, Terminal'
...
config.bind('<Ctrl-G>', 'spawn --userscript qute-bitwarden', mode='command')
